...
<body> 
  <div id="container"> 
    ...
    <div class="row"> 
      ...
      <div> 
        <div> 
          <a href="${pageContext.request.contextPath}/blog/${authUser.id}/admin/basicsetting"><font size="4">기본설정 &nbsp&nbsp</font> </a> 
          <a href=""><font size="4">카테고리 설정 &nbsp&nbsp</font> </a> 
          <a href="${pageContext.request.contextPath}/blog/${authUser.id}/admin/boardwriteForm"><font size="4">글 작성 &nbsp&nbsp</font> </a> 
        </div> 
        <br> 
        <br> 
